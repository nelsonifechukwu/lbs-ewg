...
Warn "  - hourly backups:    Task Scheduler running scripts\backup-db.sh via Git Bash/WSL"
Warn "  - cross-machine sync: OneDrive/Dropbox on backend\lbs.db (use a symlink: mklink)"

Log ""
Log "Setup complete."
Log "Start the app with:  bash dev.sh   (Git Bash or WSL required — dev.sh is a bash script)"
